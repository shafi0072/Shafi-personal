        ...
        <div id="about" className='backAbout'>
           ...
           <div className="row">
                <div data-aos="fade-right" className="col-md-6">
                    <p className='text-light mt-5'>I am MD Abdullah Al Shafi. I am Front End Developer. Proficient in modern
                        website design. I specialize in pixel-perfect responsive design with HTML5,
                        CSS3, Flexbox, Bootstrap, ES6, JavaScript. I also have solid knowledge working
                        with React.js and server-side node.js, express.js, MongoDB
                    </p>
                </div>
                <div data-aos="fade-left" className="col-md-6">
                    <div className="text-center mt-5">
                    <h1 className='text-light'>Contract <span className='text-success'>Info</span></h1>
